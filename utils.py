...
def get_gemini_client():
    ...
    if not gemini_api_key:
        ...
        st.info("Please check the sidebar and enter your Gemini API Key to unlock LogeekMind's AI features. If you don't have one go back to the homepage(LogeekMind) and view the LogeekMind's README & setup guide link")
        st.stop()
